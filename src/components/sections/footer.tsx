        ...
        >
            ...
            <div className="h-6 md:h-12 xl:h-24 flex flex-row justify-center items-center gap-4 md:gap-6 xl:gap-8">
                ...
                <div className="group relative h-full">
                    ...
                    <div className="absolute -z-10 inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tl from-blue-800 to-blue-500 transition-opacity duration-500 rounded-md"></div>
                </div>
